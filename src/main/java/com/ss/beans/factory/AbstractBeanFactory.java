...
public abstract class AbstractBeanFactory implements BeanFactory {
	...
	public AbstractBeanFactory(ResourceLoader resourceLoader) {
	...
	protected Object initializeBean(Object bean, String name) throws Exception {
		for (BeanProcessor beanPostProcessor : beanProcessors) {
	...
	public void addBeanProcessor(BeanProcessor beanProcessor) throws Exception {
